...
import alkweb.huawei.swindle.system.entity.CheatUsrInfoEntity;
 ...
 * @Date: 2020/3/15
 */
@Service("CheatUsrInfoService")
@Transactional(propagation = Propagation.SUPPORTS, readOnly = true, rollbackFor = Exception.class)
public class CheatUsrInfoServiceImpl extends BaseService<CheatUsrInfoEntity> implements CheatUsrInfoService {


    @Override
    public List<CheatUsrInfoEntity> findAllCheatUserInfo(MainPageQo data) {
        Example example = new Example(CheatUsrInfoEntity.class);
